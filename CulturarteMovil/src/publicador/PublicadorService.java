 ...
 * 
 */
@WebServiceClient(name = "PublicadorService", targetNamespace = "http://publicador/", wsdlLocation = "http://localhost.fing.edu.uy:3051/culturarte?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://" + defaultProps.getProperty("maquinaWeb") + ":" + defaultProps.getProperty("puertoWeb") +"/culturarte");
