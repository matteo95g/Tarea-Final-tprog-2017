 ...
 *         &lt;element name="propuestas" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends DtUsuario
{
    ...
    protected List<String> propuestas;
    ...
    public List<String> getPropuestas() {
        if (propuestas == null) {
            propuestas = new ArrayList<String>();
        }
