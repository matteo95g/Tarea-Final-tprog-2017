	...
	<body>
		<header>
			...
			<div class="col-md-4 col-md-offset-4" style="margin-top:50px; border:5px groove; border-radius:5px">
				<form id="signupform" class="form-horizontal" role="form" name="formularioPropuesta"  class="col-md-6 col-md-offset-3" action="propuestaCorrecta" >
					<h2 class="form-signin-heading" style="text-align:center">Ingrese los datos de la propuesta</h2>
					<br/>
					
					<div id="signupalert" style="display:none" role="alert" class="alert alert-danger">
  					<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
  					<span class="sr-only">Error:</span>
						<span>Ya existe una propuesta con ese nombre</span>
					</div>
					<div>
			...
			<div class="footer">
				<div class="container">
					<span class="text-muted">Taller de Programación 2017 | GRUPO 25 &COPY;</span>
				</div>
			</div>
